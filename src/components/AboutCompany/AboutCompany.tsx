    ...
    <section className="about">
      ...
      <div className="facts">
        <div className="fact-main">
          ...
          <p className="fact__description fact__description_type_main">{t('about-fact-company')}</p>
        </div>
        <ul className="facts__group">
          <li className="fact">
            <img src={option} alt="" className="fact__image" />
            <p className="fact__description">{t('about-fact-integration')}</p>
          </li>
          <li className="fact">
            <img src={idea} alt="" className="fact__image" />
            <p className="fact__description">{t('about-fact-developers')}</p>
          </li>
          <li className="fact">
            <img src={parament} alt="" className="fact__image" />
            <p className="fact__description">{t('about-fact-protected')}</p>
          </li>
        </ul>
      </div>
    </section>
