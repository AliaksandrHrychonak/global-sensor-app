...
import { dataModule, dataModule2101, dataModule2102, dataModule450, dataModule500, equipments, equipmentsAXOB, gs2100, gs2100Image, gs2101, gs2101Image, gs2102, gs2102Image, gs450, gs450Image, gs500, gs500Image } from "../../utils/pmData";
  ...
  return (
    <>
      <Routes>
        <Route
          path="/"
          element={<Main isMobile={isMobile} toggleMenu={handleMobileMenu} />}
        />
        <Route
          path="/gs2100"
          element={
        ...
        <Route path="/sign-up" element={<Registration onSubmit={handleRegister} onAcessWithGoogle={handleLoginWithGoogle}/>} />
